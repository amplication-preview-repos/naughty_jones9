...
export class TeacherResolverBase {
  ...
  async createTeacher(
    ...
    return await this.service.createTeacher({
      ...
      data: {
        ...
        machineLearningProcess: args.data.machineLearningProcess
          ? {
              connect: args.data.machineLearningProcess,
            }
          : undefined,
      },
    });
  ...
  async getMachineLearningProcess(
    @graphql.Parent() parent: Teacher
  ): Promise<MachineLearningProcess | null> {
    const result = await this.service.getMachineLearningProcess(parent.id);
