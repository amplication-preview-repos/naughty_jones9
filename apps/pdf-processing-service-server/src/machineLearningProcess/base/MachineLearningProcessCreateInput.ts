...
@InputType()
class MachineLearningProcessCreateInput {
  @ApiProperty({
    required: false,
  })
  @IsJSONValue()
  ...
  @ApiProperty({
    required: false,
    type: () => TeacherCreateNestedManyWithoutMachineLearningProcessesInput,
  })
  @ValidateNested()
  @Type(() => TeacherCreateNestedManyWithoutMachineLearningProcessesInput)
  @IsOptional()
  @Field(() => TeacherCreateNestedManyWithoutMachineLearningProcessesInput, {
    nullable: true,
  })
...
export { MachineLearningProcessCreateInput as MachineLearningProcessCreateInput };
