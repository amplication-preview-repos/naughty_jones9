...
@InputType()
class TeacherUpdateManyWithoutMachineLearningProcessesInput {
...
export { TeacherUpdateManyWithoutMachineLearningProcessesInput as TeacherUpdateManyWithoutMachineLearningProcessesInput };
